...
> defines it, e.g. `mine-flow-docs/architecture/*-architecture-overview.md`.)
...
<!--
  ...
  `Code/mine-flow-docs/scripts/apply-project-license.sh <this-repo-path>`. It copies the
...
<!-- For a service: link the versioned spec (OpenAPI / GraphQL / protobuf) as the interface
     contract of record named by `mine-flow-docs/architecture/*-interface-contracts.md`, with a short

...
Two workflows so a mine-flow project has continuous integration **from day one** — the method
...
at `Code/mine-flow-docs/.github/workflows/method-check.yml`, so in a **multi-repo** project

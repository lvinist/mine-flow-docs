# mine-flow — Privacy, Compliance & Data Governance (Conditional Session)
...
Building on the data model and threat model, we'll decide how mine-flow handles **personal

...
**Last updated:** 2026-07-22 (STEP-29.1)
...
### Typography
- **Primary UI Font:** **Inter** (or default ForUI typography stack). Best-in-class readability for dense UI and small text on screens.

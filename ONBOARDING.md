...
This scaffold stores the template at `Code/mine-flow-docs/ONBOARDING.md`. In an
initialized project, the generated docs hub path is `Code/<project>-docs/ONBOARDING.md`.
When editing template files, keep the literal `mine-flow` placeholder. When instructing
